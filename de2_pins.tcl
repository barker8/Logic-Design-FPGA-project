...
#   set_location_assignment  PIN_P26 -to EXT_CLOCK
  ...
  set_location_assignment PIN_G26  -to rest  ;# KEY0
...
#   set_location_assignment PIN_W26  -to KEY3  ;# KEY3
  ...
  set_location_assignment PIN_N25  -to switch   ;# SW[0]
  set_location_assignment PIN_N26  -to fan_di   ;# SW[1]
  # set_location_assignment PIN_P25  -to movement[0]   ;# SW[2]
  # set_location_assignment PIN_AE14 -to movement[1]   ;# SW[3]
...
#   set_location_assignment PIN_U4   -to SW[15]  ;# SW[15]
  set_location_assignment PIN_V1   -to movement[0]  ;# SW[16]
  set_location_assignment PIN_V2   -to movement[1]  ;# SW[17] on the left side
  ...
  set_location_assignment PIN_AE22  -to green_led[0] ;# LEDG[0] on the right side
  set_location_assignment PIN_AF22  -to green_led[1] ;# LEDG[1]
  set_location_assignment PIN_W19   -to green_led[2] ;# LEDG[2]
  set_location_assignment PIN_V18   -to green_led[3] ;# LEDG[3]
  set_location_assignment PIN_U18   -to green_led[4] ;# LEDG[4]
  set_location_assignment PIN_U17   -to green_led[5] ;# LEDG[5]
  set_location_assignment PIN_AA20  -to green_led[6] ;# LEDG[6]
  set_location_assignment PIN_Y18   -to green_led[7] ;# LEDG[7]
#   set_location_assignment PIN_Y12   -to LEDG[8] ;# LEDG[8] Between 7-Segments
  ...
  set_location_assignment PIN_AE23  -to red_led[0]   ;# LEDR[0]
  set_location_assignment PIN_AF23  -to red_led[1]   ;# LEDR[1]
  set_location_assignment PIN_AB21  -to red_led[2]   ;# LEDR[2]
  set_location_assignment PIN_AC22  -to red_led[3]   ;# LEDR[3]
  set_location_assignment PIN_AD22  -to red_led[4]   ;# LEDR[4]
  set_location_assignment PIN_AD23  -to red_led[5]   ;# LEDR[5]
  set_location_assignment PIN_AD21  -to red_led[6]   ;# LEDR[6]
  set_location_assignment PIN_AC21  -to red_led[7]   ;# LEDR[7]
  set_location_assignment PIN_AA14  -to red_led[8]   ;# LEDR[8]
  set_location_assignment PIN_Y13   -to red_led[9]   ;# LEDR[9]
  set_location_assignment PIN_AA13  -to red_led[10]  ;# LEDR[10]
  set_location_assignment PIN_AC14  -to red_led[11]  ;# LEDR[11]
  set_location_assignment PIN_AD15  -to red_led[12]  ;# LEDR[12]
  set_location_assignment PIN_AE15  -to red_led[13]  ;# LEDR[13]
  set_location_assignment PIN_AF13  -to red_led[14]  ;# LEDR[14]
  set_location_assignment PIN_AE13  -to red_led[15]  ;# LEDR[15]
  # set_location_assignment PIN_AE12  -to red_led[16]  ;# LEDR[16]
  # set_location_assignment PIN_AD12  -to red_led[17]  ;# LEDR[17] on the left side
...
#   set_location_assignment PIN_AA17 -to FL_WE_N
  ...
  set_location_assignment PIN_D25  -to fan[0] ;#GPIO_0[0]
  set_location_assignment PIN_J22  -to fan[1] ;#GPIO_0[1]
...
#   set_location_assignment PIN_F25  -to GPIO_0[8]
  set_location_assignment PIN_F26  -to clk_divided ;#GPIO_0[9]
